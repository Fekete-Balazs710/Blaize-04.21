	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Blaize - Forgot Password</title>
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="password-reset-code.php" method="POST">
                  ...
                  <h5 class="fw-normal mb-3 pb-3">No worries! Enter your email address and let us handle the problem. </h5>
                  ...
                  <div class="pt-1 mb-4">
                    <button class="btn nav-btn btn-lg btn-block" type="submit" name="password-reset-link">Send reset link</button>
                  </div>
