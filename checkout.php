	...
	<head>
		...
		<section class="checkout spad main-font">
			<div class="container">
					...
					<form action="#">
						<div class="row">
							<div class="col-lg-8 col-md-6">
								...
								<div class="row"> 
									<div class="form-outline mb-4 col-md-12 col-lg-12">
										<input type="text" id="form2Example17" class="form-control form-control-lg" />
								...
								<div class="row"> 
									<div class="form-outline mb-4 col-md-12 col-lg-12">
										<input type="text" id="form2Example17" class="form-control form-control-lg" />
										<label class="form-label" for="form2Example17">Postal code</label>
									</div>
								</div>
								...
								<div class="row"> 
									<div class="form-outline mb-4 col-md-12 col-lg-12">
										<input type="text" id="form2Example17" class="form-control form-control-lg" />
										<label class="form-label" for="form2Example17">Order notes (optional)</label>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-md-6">
								<div class="checkout__order">
									...
									<ul>
										<li>Natural mind<span>$75.99</span></li>
										<li>Fresh Start<span>$151.99</span></li>
										<li>Nightride<span>$53.99</span></li>
									</ul>
									<div class="checkout__order__subtotal">Subtotal <span>$750.99</span></div>
									<div class="checkout__order__total">Total <span>$750.99</span></div>

									<button type="submit" class="nav-btn" style="border: none !important">Place order</button>
								</div>
							</div>
						</div>
					</form>
