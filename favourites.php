	...
	<head>
		...
		<section class="cat_product_area main-font">
			<div class="container">


				<div class=" row col-lg-12 align-items-center latest_product_inner">


					<div class="col-lg-4 col-sm-6">
						<div class="single_product_item single_product_item2">
							<img src="img/products/product13/small.png" alt="">
							<div class="single_product_text">
								<h4>Nightride</h4>
								<p>From $35.00</p>
								<a href="#" class="add_cart">+ add to cart<i class="ti-close"></i></a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6">
						<div class="single_product_item single_product_item2">
							<img src="img/products/product26/small.png" alt="">
							<div class="single_product_text">
								<h4>Synergy</h4>
								<p>From $25.00</p>
								<a href="#" class="add_cart">+ add to cart<i class="ti-close"></i></a>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single_product_item single_product_item2">
							<img src="img/products/product06/small.png" alt="">
							<div class="single_product_text">
								<h4>The Thinker</h4>
								<p>From $25.00</p>
								<a href="#" class="add_cart">+ add to cart<i class="ti-close"></i></a>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single_product_item single_product_item2">
							<img src="img/products/product25/small.png" alt="">
							<div class="single_product_text">
								<h4>Saturated roads</h4>
								<p>From $30.00</p>
								<a href="#" class="add_cart">+ add to cart<i class="ti-close"></i></a>
							</div>
						</div>
