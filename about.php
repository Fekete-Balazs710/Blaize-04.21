...
<!-- advertisement section -->
	<div class="abt-section mb-150 section-gap">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						...
						<h2><b>We are <span class="red-text">Blaize</span></b></h2>
						<p>Etiam vulputate ut augue vel sodales. In sollicitudin neque et massa porttitor vestibulum ac vel nisi. Vestibulum placerat eget dolor sit amet posuere. In ut dolor aliquet, aliquet sapien sed, interdum velit. Nam eu molestie lorem.</p>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente facilis illo repellat veritatis minus, et labore minima mollitia qui ducimus.</p>

						<br>

						<a class="nav-btn" href="#">Shop now</a>
					</div>
				</div>
			</div>
		</div>
...
<section class="subscribe_area section-gap section_padding">
        <div class="container">
			...
			<!-- Start review Area -->
			<section class="review-area section-gap main-font section_padding" id="review">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-10">
							<div class="title text-center">
								<h2 class="mb-10"><b>Some Features that Made us Unique</b></h2>
