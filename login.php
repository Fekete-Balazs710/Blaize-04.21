    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-xl-10">
        <div class="card" style="border-radius: 1rem; border: 0px solid white !important; box-shadow: 5px 10px 18px rgba(0, 0, 0, 0.5);">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block" style="background-image: url(img/back2.jpg); border-radius: 1rem 0 0 1rem; background-size: cover; background-repeat: no-repeat; background-position: center;">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form method="post" name="login">
                  ...
                  <div class="pt-1 mb-4">
                    <button class="btn nav-btn btn-lg btn-block" type="submit">Login</button>
                  </div>
