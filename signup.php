									...
									<div class="card-body p-4 p-lg-5 text-black">
										...
										<form action="connect.php" method="POST">
											...
											<div class="d-flex align-items-center mb-3 pb-1">
												<span class="h1 fw-bold mb-0">Nice to meet you!</span>
											</div>

											<h5 class="fw-normal mb-3 pb-3">Create an account here</h5>


											<div class="form-outline mb-4" style="font-size: 15px">
												...
												<input type="text" id="form2Example17" class="form-control form-control-lg" name="lastname"/>
												...
												<input type="password" id="form2Example27" class="form-control form-control-lg" name="password1"/>
												<label class="form-label" for="form2Example27">Password</label>

												<input type="password" id="form2Example27" class="form-control form-control-lg" name="password2"/>
												<label class="form-label" for="form2Example27">Password again</label>
											...
											<div class="pt-1 mb-4">
												<button class="btn nav-btn btn-lg btn-block" type="submit">Sign up</button>
											</div>

											
											<p class=" pb-lg-2" style="color: #393f81;">Already have an account? <a href="login.php"
